...
vif(modelo)
```
Una vez identificamos que el modelo no presenta multicolinealidad en las variables y aun las probabilidades predichas son exactamente uno, se procede a identificar que la conbinacion de variables predicen correctamente el resultado:
